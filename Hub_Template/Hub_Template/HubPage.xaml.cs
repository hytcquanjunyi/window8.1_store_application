...
namespace Hub_Template
{
    ...
    public sealed partial class HubPage : Page
    {
        ...
        private async void navigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            ...
            var weather = await SampleDataSource.GeWeather();
            
            //SampleDataWeather w = weather.SingleOrDefault();//集合中如果只有一个转化成单个对象
            //this.DefaultViewModel["weatherItem"] = weather;//集合
            //this.DefaultViewModel["weatherItem"] = w;//单个对象
            //this.sp.DataContext = w;

            //this.gridweather.DataContext = w;


            this.gridweather.DataContext = weather;
            


            var city = await SampleDataSource.GetCitysAsync();
            this.DefaultViewModel["cityitem"] = city;
            
            this.DefaultViewModel["ZoomedOutList"] = this.GetSectionList();
           // httpPost("http://www.weather.com.cn/data/cityinfo/101010100.html", "", "GET");
        ...
        private void itemGridView1_ItemClick_1(object sender, ItemClickEventArgs e)
        {
            // Navigate to the appropriate destination page, configuring the new page
            // by passing required information as a navigation parameter
